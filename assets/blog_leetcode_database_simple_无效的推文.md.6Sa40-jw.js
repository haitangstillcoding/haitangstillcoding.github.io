import{_ as s,o as n,c as a,R as e}from"./chunks/framework.gZp3ZZFg.js";const m=JSON.parse('{"title":"无效的推文","description":"","frontmatter":{"hidden":true,"recommend":false,"date":"2023-12-24T11:30:00.000Z"},"headers":[],"relativePath":"blog/leetcode/database/simple/无效的推文.md","filePath":"blog/leetcode/database/simple/无效的推文.md","lastUpdated":null}'),p={name:"blog/leetcode/database/simple/无效的推文.md"},l=e(`<h1 id="无效的推文" tabindex="-1">无效的推文 <a class="header-anchor" href="#无效的推文" aria-label="Permalink to &quot;无效的推文&quot;">​</a></h1><p>表：<code>Tweets</code></p><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>+----------------+---------+</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    char_length(content) </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">&gt;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> 15</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div>`,13),i=[l];function r(t,c,b,d,o,h){return n(),a("div",null,i)}const g=s(p,[["render",r]]);export{m as __pageData,g as default};
