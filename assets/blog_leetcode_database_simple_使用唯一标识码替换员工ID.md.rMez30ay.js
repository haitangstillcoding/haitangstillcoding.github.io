import{_ as s,o as n,c as a,R as p}from"./chunks/framework.gZp3ZZFg.js";const o=JSON.parse('{"title":"使用唯一标识码替换员工ID","description":"","frontmatter":{"hidden":true,"recommend":false,"date":"2023-12-24T16:10:00.000Z"},"headers":[],"relativePath":"blog/leetcode/database/simple/使用唯一标识码替换员工ID.md","filePath":"blog/leetcode/database/simple/使用唯一标识码替换员工ID.md","lastUpdated":null}'),e={name:"blog/leetcode/database/simple/使用唯一标识码替换员工ID.md"},l=p(`<h1 id="使用唯一标识码替换员工id" tabindex="-1">使用唯一标识码替换员工ID <a class="header-anchor" href="#使用唯一标识码替换员工id" aria-label="Permalink to &quot;使用唯一标识码替换员工ID&quot;">​</a></h1><p><code>Employees</code> 表：</p><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>+---------------+---------+</span></span>
