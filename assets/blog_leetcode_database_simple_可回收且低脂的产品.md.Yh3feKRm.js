import{_ as s,o as n,c as a,U as p}from"./chunks/framework.nmnrFtMU.js";const m=JSON.parse('{"title":"可回收且低脂的产品","description":"","frontmatter":{"hidden":true,"recommend":false,"date":"2023-12-24T14:30:00.000Z"},"headers":[],"relativePath":"blog/leetcode/database/simple/可回收且低脂的产品.md","filePath":"blog/leetcode/database/simple/可回收且低脂的产品.md","lastUpdated":1703552913000}'),e={name:"blog/leetcode/database/simple/可回收且低脂的产品.md"},l=p(`<h1 id="可回收且低脂的产品" tabindex="-1">可回收且低脂的产品 <a class="header-anchor" href="#可回收且低脂的产品" aria-label="Permalink to &quot;可回收且低脂的产品&quot;">​</a></h1><p>表：<code>Products</code></p><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>+-------------+---------+</span></span>
