import{_ as s,o as n,c as a,U as p}from"./chunks/framework.nmnrFtMU.js";const o=JSON.parse('{"title":"每位教师所教授的科目种类的数量","description":"","frontmatter":{"hidden":true,"recommend":false,"date":"2023-12-24T16:00:00.000Z"},"headers":[],"relativePath":"blog/leetcode/database/simple/每位教师所教授的科目种类的数量.md","filePath":"blog/leetcode/database/simple/每位教师所教授的科目种类的数量.md","lastUpdated":1703552913000}'),e={name:"blog/leetcode/database/simple/每位教师所教授的科目种类的数量.md"},l=p(`<h1 id="每位教师所教授的科目种类的数量" tabindex="-1">每位教师所教授的科目种类的数量 <a class="header-anchor" href="#每位教师所教授的科目种类的数量" aria-label="Permalink to &quot;每位教师所教授的科目种类的数量&quot;">​</a></h1><p>表: <code>Teacher</code></p><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>+-------------+------+</span></span>
