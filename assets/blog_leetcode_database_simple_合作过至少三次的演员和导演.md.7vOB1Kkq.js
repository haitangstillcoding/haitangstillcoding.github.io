import{_ as s,o as n,c as a,U as p}from"./chunks/framework.nmnrFtMU.js";const m=JSON.parse('{"title":"合作过至少三次的演员和导演","description":"","frontmatter":{"hidden":true,"recommend":false,"date":"2023-12-24T09:00:00.000Z"},"headers":[],"relativePath":"blog/leetcode/database/simple/合作过至少三次的演员和导演.md","filePath":"blog/leetcode/database/simple/合作过至少三次的演员和导演.md","lastUpdated":1703552913000}'),e={name:"blog/leetcode/database/simple/合作过至少三次的演员和导演.md"},i=p(`<h1 id="合作过至少三次的演员和导演" tabindex="-1">合作过至少三次的演员和导演 <a class="header-anchor" href="#合作过至少三次的演员和导演" aria-label="Permalink to &quot;合作过至少三次的演员和导演&quot;">​</a></h1><p><code>ActorDirector</code> 表：</p><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>+-------------+---------+</span></span>
