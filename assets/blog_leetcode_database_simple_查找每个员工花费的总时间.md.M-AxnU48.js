import{_ as s,o as n,c as a,R as p}from"./chunks/framework.gZp3ZZFg.js";const o=JSON.parse('{"title":"查找每个员工花费的总时间","description":"","frontmatter":{"hidden":true,"recommend":false,"date":"2023-12-24T15:00:00.000Z"},"headers":[],"relativePath":"blog/leetcode/database/simple/查找每个员工花费的总时间.md","filePath":"blog/leetcode/database/simple/查找每个员工花费的总时间.md","lastUpdated":null}'),e={name:"blog/leetcode/database/simple/查找每个员工花费的总时间.md"},l=p(`<h1 id="查找每个员工花费的总时间" tabindex="-1">查找每个员工花费的总时间 <a class="header-anchor" href="#查找每个员工花费的总时间" aria-label="Permalink to &quot;查找每个员工花费的总时间&quot;">​</a></h1><p>表: <code>Employees</code></p><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>+-------------+------+</span></span>
